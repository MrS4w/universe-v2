...
<div class="header center white-text">
	<%request.getSession().setAttribute("galaxiaencontrada", null);%>
	<%request.getSession().setAttribute("bnencontrado", null);%>
	<%request.getSession().setAttribute("sistemaencontrado", null);%>
	<%request.getSession().setAttribute("estrelaencontrada", null);%>
	...
	<a type="button" href="index?action=Listar" class="blue-grey darken-4 waves-effect waves-light btn"><i class="large material-icons">list</i></a>
</div>
