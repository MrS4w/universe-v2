...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
      ...
      <div class="row center">
        <a type="button" name="inserir" href="inserir.jsp" class="blue-grey darken-4 waves-effect waves-light btn">
      ...
      <div class="row center">
        <a type="button" href="listar.jsp" class="blue-grey darken-4 waves-effect waves-light btn">Listar
