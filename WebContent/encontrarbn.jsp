...
<%
	BuracosNegros bn = (BuracosNegros) request.getSession().getAttribute("bnencontrado");
	if (bn == null) {
		out.println("<h3 class='center white-text'>Não há buracos negros com esse nome!</h3>");
	 %>
